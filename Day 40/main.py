...
# Set the updated destination data in DataManager and update the Google Sheet
data_manager.destination_data = sheet_data
data_manager.update_destination_codes()  # This sends PUT requests to update iataCode in Sheety

# ==================== Retrieve your customer emails ====================

customer_data = data_manager.get_customer_emails()
# Assuming the column name in your sheet for email is 'whatIsYourEmail?'
